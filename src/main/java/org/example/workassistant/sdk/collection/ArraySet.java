 ...
 */
package org.example.workassistant.sdk.collection;
 ...
 * Note:
 * <p>
 * This class is copied from <a href="https://android.googlesource.com/platform/frameworks/base/+/HEAD/core/java/android/util/ArraySet.java">Android ArraySet</a>
 * </p>
 * <p>
 * ArraySet is a generic set data structure that is designed to be more memory efficient than a
 * traditional {@link HashSet}.  The design is very similar to
 * {@link ArrayMap}, with all the caveats described there.  This implementation is
 ...
 */
public final class ArraySet<E> implements Collection<E>, Set<E>, RandomAccess {

    static final int[] EMPTY_HASHES = new int[0];
    ...
    // Hashes are an implementation detail. Use public API.
    int[] mHashes;
    // Storage is an implementation detail. Use public API.
    Object[] mArray;
    // Use size()
    int mSize;
...
//                    }
    ...
    // Hashes are an implementation detail. Use indexOfKey(Object).
...
//                        + " [1]=" + array[1]);
     ...
     * {android.os.Build.VERSION_CODES#Q} and later.</p>
     *
    ...
    public E valueAt(int index) {
        if (index >= mSize) {
            ...
            // Check if exception should be thrown outside the critical path.
     ...
     * bounds. This allows testing values at the end of the internal array, outside the
     * [0, mSize) bounds.
     */
...
//            }
    ...
    @SafeVarargs
    public final <T extends E> void addAll(T... elements) {
    ...
    public boolean removeAll(ArraySet<? extends E> array) {
        ...
        //       collection pass into a new array. This avoids binary searches and excessive memory.
        final int N = array.mSize;
    ...
    public boolean removeIf(Predicate<? super E> filter) {
        ...
        if (shouldShrink()) {
            ...
            // writing twice to the same index or writing unnecessarily if the array had been
            // discarded anyway.
    ...
    /**
     * Determine if the array set contains all the values in the given collection.
     *
